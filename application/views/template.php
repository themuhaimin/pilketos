...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>PIL</b> KETOS</span>
    </a>
    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <!-- aplicatio tittle -->
	<div id="title">APLIKASI MANAJEMEN PEMILIHAN KETUA OSIS SMP N 1 KALIWUNGU</div>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="<?php echo base_url(); ?>admin/calon">
            ...
            <span>Kelola Calon Ketua OSIS</span>
          </a>
        </li>
        <li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>admin/rekap"><i class="fa fa-circle-o"></i> Hasil Rekapitulasi</a></li>
            <li><a href="<?php echo base_url(); ?>admin/chart"><i class="fa fa-circle-o"></i> Grafik Perolehan Suara</a></li>
          </ul>
        </li>
		<li class="treeview">
          <a href="<?php echo base_url(); ?>admin/logout_admin">
  ...
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      ICT<strong>SMP NEGERI 1 KALIWUNGU</strong> 
    </div>
    <strong>&COPY MUHAIMIN 2016</strong> 
  </footer>
